...

{
  ...
  "version": 1,
  "securityGroups": [],
  "displayName": "Custom CMP \u2013 Consent Init \u0026 Banner Loader",
  "categories": [
    "UTILITY",
    "ANALYTICS",
    "ADVERTISING"
  ],
  "description": "Sets Google Consent Mode default states (per-type dropdowns, matching Google's native consent settings) \u2014 all 7 types denied by default on first visit \u2014 and, optionally, loads the custom consent banner script. Add this tag once, fired on the built-in \u0027Consent Initialization - All Pages\u0027 trigger.",
  "containerContexts": [
    "WEB"
  ]
}
...
[
  ...
  },
  {
    ...
    "enablingConditions": [
      { "paramName": "loadBanner", "paramValue": true, "type": "EQUALS" }
    ],
    "valueValidators": [
      { "type": "NON_EMPTY", "errorMessage": "Enter the hosted URL of cmp-banner.js" }
    ]
  },
  {
    "type": "TEXT",
